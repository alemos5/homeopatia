...
<input id="transaccion" type="hidden" value="<?php echo e(session('transaccion')); ?>">
<div class="card">
    <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        <tbody>
                          ...
                          <input id="codigoe" value="<?php echo e(Auth::user()->code_cliente); ?>" type="hidden">
                          </tr>
                          <tr>
        ...
        <div class="col-md-4">
                <img width="70%" src="<?php echo e(asset('images/epayco.png')); ?>" alt="">
        </div>
    </div>
