...
<?php endif; ?>
<input type="hidden" id="tipocliente" value="<?php echo e(Auth::user()->cliente_envio); ?>">
<div class="card">
    <div class="card-body">
        ...
        <table id="data-table" class="table table-striped table-bordered dt-responsive nowrap">
            ...
            <tbody>
                <?php $__currentLoopData = $prealertas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prealerta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($prealerta->nu_orden); ?></td>
                    <td><?php echo e($prealerta->tienda); ?></td>
                    <td><?php echo e($prealerta->valor); ?></td>
                    <td>
                        <?php if( $prealerta->tipoenvio == 0 || $prealerta->tipoenvio == null  ): ?>
                        <div class="label label-table label-warning">En espera</div>
                        <?php else: ?>
                        <div class="label label-table label-success"><?php echo e($prealerta->tipoenvio); ?></div>
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($prealerta->tracking); ?></td>
                    <td><?php echo e($prealerta->courier); ?></td>
                    <td><?php echo e(date('Y-m-d',strtotime($prealerta->fecha))); ?></td>
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?php echo e(url('/pre-alertas/mostrar/'.$prealerta->id_orden_cli)); ?>">Ver</a>
                            </div>
                        </div>
                    </td>
                </tr>
