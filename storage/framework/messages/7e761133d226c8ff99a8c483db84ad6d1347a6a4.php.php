	...
	<div class="container shop-page my-4" style="background: rgba(255,255,255,.83);border-radius: 10px; padding: 20px;">
		<div class="row">
			<div class="col col-12 col-sm-4 offset-sm-1 card-section">
				<img class="w-100 my-5 img-responsive" src="<?php echo e(asset('158624558/images/slide-img3.png')); ?>">
			...
			<div class="col col-12 col-sm-6 form-section px-5">
				...
				<form action="<?php echo e(route('giftcards.store')); ?>" method="post" id="buy">
					...
					<br>	
				 	...
				 	<div class="form-group" v-show="!combo">
						...
						<input autocomplete="off"  type="text" name="amount" v-on:keyup="total2()" v-model="amount" id="amount" class="form-control<?php echo e($errors->has('amount') ? ' is-invalid' : ''); ?>" placeholder="$25.00 - $500.00" required>
				...
				<hr>
					...
					<div v-if="selected" class="mt-5">
					 	<div class="form-group">
							...
							<input type="text" name="fullname_referred" class="form-control<?php echo e($errors->has('fullname_referred') ? ' is-invalid' : ''); ?>" placeholder="Nombre de quien recibe" required>
							<?php if($errors->has('fullname_referred')): ?>
							    <span class="invalid-feedback">
							        <strong><?php echo e($errors->first('fullname_referred')); ?></strong>
							    </span>
							<?php endif; ?>
					 	</div>
					 	<div class="form-group">
						 	<label class="form-text" for="email_referred">Email: </label>
							<input type="text" name="email_referred" class="form-control<?php echo e($errors->has('email_referred') ? ' is-invalid' : ''); ?>" placeholder="user@mail.com" required>
							<?php if($errors->has('email_referred')): ?>
							    <span class="invalid-feedback">
							        <strong><?php echo e($errors->first('email_referred')); ?></strong>
							    </span>
							<?php endif; ?>
					 	</div>
					 	<div class="form-group">
						...
						<input style="display: block;" type="tel" name="cell_referred" id="phone" class="form-control">	
							...
							<?php if($errors->has('cell_referred')): ?>
							    <span class="invalid-feedback">
							        <strong><?php echo e($errors->first('cell_referred')); ?></strong>
							    </span>
							<?php endif; ?>
					 	</div>
				 	 	<div class="form-group">
	        ...
	        methods: {
	        	...
	        	inicializar: function() {
				    ...
				    window.intlTelInput(input, {
				      ...
				      utilsScript: "<?php echo e(asset('js/web/utils.js')); ?>",
				  });
  				},
