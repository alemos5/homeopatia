<?php $__env->startSection('title', 'Detalles de GiftCard'); ?>
                ...
                <?php if(!empty($referred)): ?>
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($referred->fullname_referred); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="control-label">Celular: </label>
                            <input type="text" class="form-control" value="<?php echo e($referred->cell_referred); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="control-label">Monto: </label>
                            <input type="text" class="form-control" value="<?php echo e($referred->email_referred); ?>" readonly>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            <div class="row">
            	<div class="col-12">
            		<div class="form-group">
            		    ...
            		    <textarea rows="4" class="form-control" readonly><?php echo e($giftcard->message); ?></textarea>
            		</div>
            	</div>
            </div>
            <div class="row">
