...
<?php $__env->startSection('content'); ?>
    <section class="content-header">
        <h1 class="pull-left">
            Créditos de Clientes "Consolidado"
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <?php echo $__env->make('creditos.table_consolidado', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
