...
<div id="page">
    <div class="card">
   <div class="card-body">
       <a href="<?php echo e(route('programar-envios')); ?>"><button class="btn btn-outline-success"> <i class="fas fa-plus"></i> Programar Envío</button></a>
      <table style="width: 100%; font-size: 14px;" id="data-table" class="table table-striped table-bordered dt-responsive nowrap">
           ...
           <tbody>
               <?php $__currentLoopData = $ordenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orden): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <tr <?php if( ($orden->estatus_manifiesto == 0 && $orden->status == 0) ||  ($orden->estatus_manifiesto == null && $orden->status == 0)): ?> style='background: #fff;  font-weight: 500;' <?php endif; ?>>
                     <td>
                       <?php if(($orden->estatus_manifiesto == 0 && $orden->status == 0) ||  ($orden->estatus_manifiesto == null && $orden->status == 0)): ?>
                       <div class="form-check">
                         <input class="form-check-input" type="checkbox" v-on:change.prevent="listaids(<?php echo e($orden->id_orden); ?>)"  value="" id="check<?php echo e($orden->ware_reciept); ?>">
                         <label class="form-check-label" for="check<?php echo e($orden->ware_reciept); ?>">
                         </label>
                       </div>
                       <?php endif; ?>
                     </td>
                       ...
                       <td><?php echo e($orden->peso); ?></td>
                       <td><a href="<?php echo e(url('/ordenes/mostrar/'.$orden->ware_reciept)); ?>">
                        <?php if($orden->estatus_manifiesto == null): ?>
                           <?php if($orden->status == '1' && $orden->instrucciones == '2'): ?>
                               Procesando
                           <?php elseif($orden->instrucciones == '7'): ?>
                               Instrucciones recibidas
                            <?php elseif($orden->instrucciones == '0' && $orden->status == '0'): ?>
                              En bodega
                           <?php endif; ?>

                        <?php else: ?>
                        <?php echo e(estatus($orden->estatus_manifiesto)); ?>

                        <?php endif; ?>
                        
                      </a></td>
                       <td><?php if($orden->doc == 0): ?>
                        No Disponible 
                        <?php else: ?>
                         <?php echo e($orden->doc); ?> 
                       <?php endif; ?></td>
                       <td><a href="<?php echo e(url('/ordenes/mostrar/'.$orden->ware_reciept)); ?>">
...
<div v-if="mostrarp" style="top: 10%; position: fixed; z-index: 100000;" class="card card-inverse card-primary" >
 <div class="card-body">
    <form action="<?php echo route('programar-envios'); ?>" method="get">
