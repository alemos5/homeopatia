        ...
        <form action="<?php echo e(route('transfers.store', [$giftcard->id])); ?>" class="form-horizontal row" method="post">
            ...
            <div class="col-md-5 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="total_reimbursable" value="<?php echo e(number_format(($giftcard->amount - ($giftcard->amount * 0.05)) * $rate, 2, ',', '.')); ?>" readonly required>
                </div>
                <div class="form-group">
