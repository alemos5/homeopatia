...
<div class="alert alert-danger"> <i class="ti-warning"></i> Tiene un proceso de pago de envio pendiente, por favor completalo:
    <br>
    <b><a href="<?php echo e(route('facturaciondhl')); ?>">Pagar Ahora</a></b>
    <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
</div>
<?php endif; ?>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                ...
                <input id="vtotal" type="hidden" value="<?php echo e($vtotal); ?>"> <?php echo e($visita->prealerta); ?>
                ...
                <div class="table-responsive d-none d-sm-block">
                    <table style="font-size: 13px;" id="data-table" class="table table-striped table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $programar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="<?php echo e($item->ware_reciept); ?>">
                                <td><span data-toggle="modal" data-target="#verPaqueteModal" v-on:click.prevent="verPaquete(<?php echo e($item); ?>)"> <i class="fas fa-eye text-success"></i> &nbsp;</span> <?php echo e($item->ware_reciept); ?></td>
                                <td data-toggle="tooltip" data-placement="bottom" title="<?php echo e($item->tracking); ?>"><?php echo e(cortar_palabra($item->tracking)); ?></td>
                                <td data-toggle="tooltip" data-placement="bottom" title="<?php echo e($item->descripcion); ?>"><?php echo e(cortar_palabras($item->descripcion)); ?></td>
                                <?php
                            ...
                            ?>
                                    <td data-step="1" data-intro="Agregue el valor declarado de su envio y precione el boton (+)">
                                        ...
                                        <input id="<?php echo e($item->id_orden); ?>" type="number" class="form-control" style="width: 40%" placeholder="USD">
                                        <button style="margin-top:-3px;" v-on:click.prevent="sendPaquete(<?php echo e($item); ?>,<?php echo $item->id_orden; ?>, '<?php echo $item->ware_reciept; ?>','<?php echo $item->code_cliente; ?>')" class="btn btn-success">
    ...
    <div class="col-md-4">
        <form id="myForm" action="#" v-on:submit.prevent="createEnvioItem()" method="post">
            ...
            <h4>Información adicional</h4> <?php if(Auth::user()->cliente_envio == 1): ?>
            <input type="hidden" id="id_cli" name="id_cliente" value="<?php echo e(Auth::user()->id_cliente); ?>">
            ...
            <div style="background:#FFCC00; border-radius: 5px; padding:15px;">
                <img class="mx-auto d-block" src="<?php echo e(asset('images/envio.png')); ?>" style="max-width:200px;" alt="">
...
<?php if(isset($visita->prealerta)): ?>
    <?php if($visita->prealerta == 0): ?>
        <script>
  ...
  var page = new Vue({
    ...
    computed: {
  	...
  	methods: {
        ...
        noMostrar(){
            axios.get('/api/visitap/<?php echo e(Auth::user()->code_cliente); ?>').then((response) =>  {
                 introJs().exit();
            });
        },
  		calcPeso(){
