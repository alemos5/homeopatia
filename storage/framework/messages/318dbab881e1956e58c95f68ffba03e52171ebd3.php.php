<div class="gp gry-lyr hg-opc">
    ...
    <div class="parlx" style="background-image: url(<?php echo e(asset('images/parlx-bg1.jpg')); ?>);"></div>
    <div class="container">
        <div class="row">
                ...
                <div class="amz-fea">
                    <div class="row">
                        <div class="col-md-5 col-sm-6 hidden-sm-down col-lg-5">
                            <div class="amz-mckp"><img src="<?php echo e(asset('images/resource/amz-mckp1.png')); ?>" alt="" /></div>
                        </div>
