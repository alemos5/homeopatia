			...
			<div class="first-part row">
				...
				<div class="col px-sm-5">
					...
					<div class="text-center">
						<a href="<?php echo e(route('login')); ?>" class="btn-login btn w-75 mt-3 py-2">
							Ingresar
						</a>
						<a href="<?php echo e(route('register')); ?>" class="btn-login btn w-75 mt-3 py-2">
							Regístrate
						</a>
...
<?php echo $__env->make('web.giftcards.layout', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>