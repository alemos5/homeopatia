...
<body>
    ...
    <main>
        ...
        <section id="home">
            ...
            <?php echo $__env->make('web.partials.home', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        </section>

        <section id="services">

            <?php echo $__env->make('web.partials.services', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        </section>

        <section>

            <?php echo $__env->make('web.partials.accordion', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        </section>

        <section id="about">

            <?php echo $__env->make('web.partials.about', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <section id="contact">
            ...
            <?php echo $__env->make('web.partials.contact', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
