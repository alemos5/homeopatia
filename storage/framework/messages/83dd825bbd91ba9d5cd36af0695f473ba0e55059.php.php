    ...
    <?php $__currentLoopData = $promo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
              <div class="card-body">
                <h4 class="card-title text-center"><?php echo e($value->nombre); ?></h4>
                <p class="card-text"><?php echo e($value->descripcion); ?></p>
                 <?php $__currentLoopData = $promovar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valuevar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($value->id == $valuevar->id_promocion): ?>
                    <a href="#" onclick="amount = <?php echo e($valuevar->precio); ?>; promo = <?php echo e($valuevar->id); ?>;  event.preventDefault(); " class="btn btn-secondary btn-block"><?php echo e($valuevar->peso); ?> Lbs - <?php echo e($valuevar->precio); ?> Uds </a>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-4 align-self-center">
            ...
            <img src="<?php echo e(asset('images/paypal.png')); ?>" alt="" width="70%">
                <form method="POST" id="paypalForm" action="<?php echo e(route('create-payment-promo')); ?>">
       ...
       $('#epayco-button').click(function(){
        if(amount == 0){
         ...
         var handler = ePayco.checkout.configure({
            ...
            extra2: "extra2",
            extra3: "extra3",
            confirmation: "<?php echo e(URL::to('/checkoutfinishpromo')); ?>",
            response: "<?php echo e(URL::to('/checkoutfinishpromo')); ?>",
