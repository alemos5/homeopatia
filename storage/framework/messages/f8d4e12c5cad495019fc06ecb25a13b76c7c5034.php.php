...
<div class="alert alert-danger"> <i class="ti-warning"></i> Tiene un proceso de pago de envio pendiente, por favor completalo:  <br>
    <b><a href="<?php echo e(url('checkout/'.$pagodhl->usd.'/'.$pagodhl->cop)); ?>">Pagar Ahora</a></b>
...
<?php if(Auth::user()->direccion == ''): ?>
    ...
    <b><a href="<?php echo e(route('perfil')); ?>">Completar perfil</a></b>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
    </div>
<?php endif; ?>
<button style="margin-bottom:15px;"  onclick="javascript:introJs().setOptions({nextLabel:'Siguiente', prevLabel:'Anterior', doneLabel: 'No mostrar más', 'skipLabel': 'Saltar' }).start();" class="btn btn-success btn-sm">Ver guía de uso</button> <br>
      ...
      <div class="row">
                     ...
                     <div class="col-lg-3 col-md-6" data-step="4" data-intro="Aquí podrás crear pre alertas para notificarnos del envío y agilizar el proceso." >
                        <div class="card">
                            <div class="card-body" style="padding: 0">
                               <?php if(Auth::user()->direccion != '' && $pagodhl == '0'  ): ?> <a href="#" data-toggle="modal" data-target="#prealertaModal" data-backdrop="static" data-keyboard="false">
                                <?php endif; ?>
                                    <div class="d-flex flex-row">
                                        <div  style="" class="bg-success ticket">
                                            <div class="m-md-3">   
                                                    <img class=""  width="60px;" src="<?php echo e(asset('images/prealertar.png')); ?>" alt="">
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-3 col-md-6" data-step="5" data-intro="Aquí podrás programar tus envíos, declarar los valores y seleccionar las direcciones donde deseas recibir tus paquetes." class="table browser m-t-0 no-border">
                        <div class="card">
                            <div class="card-body" style="padding: 0">
                                <a href="<?php echo e(route('programar-envios')); ?>">
                                <div class="d-flex flex-row">
                                    <div  class="bg-success ticket">
                                        <div class="m-md-3">   
                                                <img class=""  width="60px;" src="<?php echo e(asset('images/programar-envio.png')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="m-l-10 p-md-3 align-self-center">
                        ...
                        <div class="card">
                            <div class="card-body" style="padding: 0">
                                ...
                                <div class="d-flex flex-row">
                                    <div   class="bg-success ticket">
                                        <div class="m-md-3">   
                                                <img class=""  width="60px;" src="<?php echo e(asset('images/rastrea.png')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="m-l-10 p-md-3 align-self-center">
                        ...
                        <div class="card">
                            <div class="card-body" style="padding: 0">
                                <div class="d-flex flex-row">
                                    <div  class="bg-success ticket">
                                        <div class="m-md-3">   
                                                <img class=""  width="60px;" src="<?php echo e(asset('images/puntos.png')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="m-l-10 p-md-3 align-self-center">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title"><?php echo e(Auth::user()->nombre); ?></h3>
                                <div data-step="1" data-intro="Este es tu código de casillero.">
                                    <h6 class="card-subtitle">Cliente Nº <?php echo e(Auth::user()->code_cliente); ?></h6>
                                </div>
                                ...
                                <table data-step="2" data-intro="A estas direcciones debes enviar tus paquetes, dependiendo del país donde realizaste la compra" class="table browser m-t-0 no-border">
                                    <tbody>
                                        <tr>
                                            <td style="width:48px;"><img style="width:48px;" src="<?php echo e(asset('images/USA.png')); ?>" alt="logo"></td>
                                            <td><span class="label label-inverse">USA </span> <?php echo e(Auth::user()->nombre); ?>  / <?php echo e(Auth::user()->code_cliente); ?> <br> <span style="margin-left: 45px;"> 3509 nw 115 Ave, Doral FL 33178 </span></td>
                                        </tr>
                                        <tr>
                                            <td><img style="width:48px;"  src="<?php echo e(asset('images/SPAIN.png')); ?>"  alt="logo"></td>
                                            <td><span class="label label-inverse">ESP</span> <?php echo e(Auth::user()->nombre); ?> / <?php echo e(Auth::user()->code_cliente); ?> <br> <span style="margin-left: 45px;">Avd de las Américas 4 Nave B6 CP 28823 Coslada </span></td>
                                    </tbody>
                                </table>
                                <a href="<?php echo e(route('direcciones')); ?>">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <a href="<?php echo e(route('directorio')); ?>">
    ...
    <div class="modal fade" id="rastrearModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xs" role="document" >
                <form action="<?php echo e(route('ordenes-buscar')); ?>"  method="get">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="prealertaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document" >
        <form action="<?php echo e(route('prealerta.store')); ?>" class="dropzone" id="my-dz" files="true" method="post">
            <?php echo csrf_field(); ?>
            <div class="modal-content">
                <div class="modal-body">
                    <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <select name="direccion" class="form-control" id="" required>
                                    ...
                                    <?php else: ?>
                                    <option value="<?php echo e($direccion1); ?>"><?php echo e($direccion1); ?></option>
                                    <?php endif; ?>
                                </select>
                            </div>
                            ...
                            <input type="hidden" name="id_cli" value="<?php echo e(Auth::user()->id_cliente); ?>">
                        </div>
                    </div>
                    <!--/row-->
                </div>
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="hidden" id="id_cli" name="id_cliente" value="<?php echo e(Auth::user()->id_cliente); ?>" required>
            </div>
        </div>
      </div>
      <div class="modal-footer">
...
<script type="text/javascript">
  var page = new Vue({
     ...
     data () {
  	...
  	methods: {
        noMostrar(){
            axios.get('/api/visitah/<?php echo e(Auth::user()->code_cliente); ?>').then((response) =>  {
                introJs().exit();
            });
        },
...
<?php if(isset($visita->home)): ?>
    <?php if($visita->home == 0): ?>
        <script>
