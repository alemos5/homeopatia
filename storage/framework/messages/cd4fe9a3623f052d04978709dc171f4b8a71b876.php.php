<div class="row">
    ...
    <div class="form-group col-sm-6">
        <?php echo Form::label('descripcion', _i('Descripción ESP:')); ?>
    ...
    <div class="form-group col-sm-6">
        <?php echo Form::label('descripcion_en', _i('Descripción ENG:')); ?>

        <?php echo Form::textarea('descripcion_en', null, ['class' => 'form-control']); ?>
    ...
    <!-- Submit Field -->
    <div class="form-group col-sm-12">
        <?php echo Form::submit(_i('Guardar'), ['class' => 'btn btn-primary']); ?>

        <a href="<?php echo route('remedios.index'); ?>" class="btn btn-default"><?php echo e(_i('Cancelar')); ?></a>
    </div>
