    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <p>{{ _i('Su clave ha sido cambiada por el administrador del sistema, le recomendamos cambie dicha contraseña en virtud de mantener la seguridad de los datos.') }}</p>
