<div class="row">
    ...
    <div class="form-group col-sm-6">
        {!! Form::label('descripcion', _i('Descripción ESP:')) !!}
        {!! Form::textarea('descripcion', null, ['class' => 'form-control']) !!}
    </div>

    <div class="form-group col-sm-6">
        {!! Form::label('descripcion_en', _i('Descripción ENG:')) !!}
    ...
    <!-- Submit Field -->
    <div class="form-group col-sm-12">
        {!! Form::submit(_i('Guardar'), ['class' => 'btn btn-primary']) !!}
        <a href="{!! route('remedios.index') !!}" class="btn btn-default">{{ _i('Cancelar') }}</a>
    </div>
